...
# def get_sampling_eta_prime_JAX(param_dict, red_cov_approx_matrix, cp_cp_noise, cp_freq_inv_noise_sqrt, map_random_x=[], map_random_y=[], initial_guess=[], lmin=0, n_iter=8, limit_iter_cg=1000, tolerance=10**(-12)):
...
# def get_fluctuating_term_maps_JAX(param_dict, red_cov_matrix, cp_cp_noise, cp_freq_inv_noise_sqrt, map_random_realization_xi=[], map_random_realization_chi=[], initial_guess=[], lmin=0, n_iter=8, limit_iter_cg=1000, tolerance=10**(-12)):
#     """ 
...
# def get_inverse_wishart_sampling_from_c_ells_JAX(sigma_ell, q_prior=0, l_min=0, option_ell_2=2):
