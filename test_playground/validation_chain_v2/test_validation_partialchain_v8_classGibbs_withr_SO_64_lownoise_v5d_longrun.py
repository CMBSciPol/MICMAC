...
file_ver = 'full_v8_classGchain_SO_noise_v5e' # reduced noise by 10 + classGibbs + test_full_chain_v1a + C_approx only lensing ; start_r=10**(-2) + exact values B_f
file_ver = 'full_v8_classGchain_SO_noise_v5f' # -> 1000 iterations + reduced noise by 10 + classGibbs + test_full_chain_v1a + C_approx only lensing ; start_r=10**(-2) + exact values B_f
reduction_noise_ratio = 10
file_ver = 'full_v8_classGchain_SO_noise_v5fb' # -> 1000 iterations, seed 42, 1b toml file + reduced noise by 100 + classGibbs + test_full_chain_v1a + C_approx only lensing ; start_r=10**(-2) + exact values B_f
reduction_noise_ratio = 100
file_ver = 'full_v8_classGchain_SO_noise_v5fc' # -> 1000 iterations, seed 43, 1c toml file, step-size_r 1e-4 + reduced noise by 100 + classGibbs + test_full_chain_v1a + C_approx only lensing ; start_r=10**(-2) + exact values B_f
reduction_noise_ratio = 100
