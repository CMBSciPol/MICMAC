#!/bin/bash
#SBATCH --job-name=biased_LB_fullsky_2b_5nodes_gpu
...
export VER=biased_fullsky_LB_v104_v2b_gpu
export additional_config_file=add_gpu_biased_fullsky_LB_v2b.toml
