...
#SBATCH --job-name=LB_ns2_micmac_v100
#SBATCH --partition quiet

#SBATCH --mail-user=rizzieri@apc.in2p3.fr
#SBATCH --mail-type=ALL

#SBATCH --output=micmac_v100_LB_ns2.out
...
export file_ver=corr_cutsky_LB_d1s1_nside2_v1a2
export add_param_toml=add_corr_cutsky_LB_d1s1_nside2_v1a
