...
#SBATCH --job-name=LB_ns16_micmac_2000
#SBATCH --partition quiet

#SBATCH --mail-user=rizzieri@apc.in2p3.fr
#SBATCH --mail-type=ALL

#SBATCH --output=micmac_v100_LB_ns16_2000.out
...
# first 2000
export file_ver=corr_cutsky_LB_d1s1_nside16_v1a
export add_param_toml=add_corr_cutsky_LB_d1s1_nside16_v1a
