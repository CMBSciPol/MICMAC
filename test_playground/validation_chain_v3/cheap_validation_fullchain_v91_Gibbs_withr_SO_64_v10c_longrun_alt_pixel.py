...
file_ver = 'full_v91_Gchain_SO_64_v9c' # -> 10000 iterations + gap=4 + test_full_chain_v1c + initial_guess_r = 1e-2 ; test_full_chain_v1a + C_approx only lensing ; start_r=10**(-2) + exact values B_f
file_ver = 'full_v91_Gchain_SO_64_v10b' # -> 4000 iterations + gap=4 + test_full_chain_v1d + initial_guess_r = 1e-3 ; test_full_chain_v1a + C_approx only lensing ; start_r=10**(-2) + exact values B_f
reduction_noise = 1
