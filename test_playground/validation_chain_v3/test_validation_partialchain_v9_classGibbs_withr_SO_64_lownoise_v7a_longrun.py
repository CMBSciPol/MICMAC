...
file_ver = 'full_v9_classGchain_SO_noise_v6a' # -> 10 iterations, 1a toml file, step-size_r 1e-4 + reduced noise by 100 + classGibbs + test_full_chain_v1a + C_approx only lensing ; start_r=10**(-2) + exact values B_f
...
file_ver = 'full_v9_classGchain_SO_noise_v7a' # -> 1000 iterations, seed 42, 1b toml file, step-size_r 1e-4 + reduced noise by 100 + classGibbs + test_full_chain_v1a + C_approx only lensing ; start_r=10**(-2) + exact values B_f
file_ver = 'full_v9_classGchain_SO_noise_v7b' # -> 1000 iterations, seed 42, 1b toml file, step-size_r 1e-4 + reduced noise by 100 + classGibbs + test_full_chain_v1a + C_approx only lensing ; start_r=10**(-2) + exact values B_f
file_ver = 'full_v9_classGchain_SO_noise_v7c' # -> 5000 iterations, seed 43, 1c toml file, step-size_r 1e-4 + reduced noise by 100 + classGibbs + test_full_chain_v1a + C_approx only lensing ; start_r=10**(-2) + exact values B_f
...
path_toml_file = directory_toml_file + 'test_classical_chain_v1b.toml'
path_toml_file = directory_toml_file + 'test_classical_chain_v1c.toml'
