...
former_file_ver = 'corr_masked_full_v102_Gchain_SO_64_v1dbbb' # -> corr inhomogeneous + r=0 + 2000 iterations + corr_v1ccb + w/o restrict_to_mask + mask ; C_approx only lensing
...
file_ver = 'corr_masked_full_v102_Gchain_SO_64_v1dbbbb' # -> corr inhomogeneous + r=0 + 2000 iterations + corr_v1ccbb + w/o restrict_to_mask + mask ; C_approx only lensing
# -> TODO !!!
reduction_noise = 1
factor_Fisher = 1
