...
file_ver = 'corr_masked_full_v102_Gchain_SO_64_v1b' # -> corr r=1e-3 + 2000 iterations + corr_v1b + w/o restrict_to_mask + mask ; C_approx only lensing
# -> TODO !!!
reduction_noise = 1
factor_Fisher = 1
...
path_toml_file = directory_toml_file + 'corr_v1b.toml'
