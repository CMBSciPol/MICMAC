...
# export VER=corr_masked_full_v102_Gchain_SO_64_v1hb
export VER=corr_masked_full_v102_Gchain_SO_64_v1i
...
srun python $SRC_PATH/very_cheap_corr_masked_fullchain_v102_Gibbs_withr_SO_64_v1cb_longrun.py  1> $SRC_PATH/logs/log_$VER.log 2> $SRC_PATH/errs/err_$VER.log
