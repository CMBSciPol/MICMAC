...
file_ver = 'corr_masked_full_v102_Gchain_SO_64_v1e' # -> corr LiteBIRD + r=1e-2 + 2000 iterations + corr_v1d_LiteBIRD + w/o restrict_to_mask + unmasked ; C_approx only lensing
# -> TODO !!!
reduction_noise = 1
factor_Fisher = 1
