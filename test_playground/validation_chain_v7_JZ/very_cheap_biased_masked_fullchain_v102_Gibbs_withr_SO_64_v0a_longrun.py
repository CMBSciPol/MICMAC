...
file_ver = 'biased_masked_full_v102_Gchain_SO_64_v0a' # -> biased GPU + r=1e-2 + 100 iterations + biased_v0a + w/o restrict_to_mask + mask ; C_approx only lensing
# -> TODO !!!
reduction_noise = 1
factor_Fisher = 1
...
path_toml_file = directory_toml_file + 'biased_v0a.toml'
