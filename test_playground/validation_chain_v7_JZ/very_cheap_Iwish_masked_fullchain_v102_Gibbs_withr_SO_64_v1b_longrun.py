...
file_ver = 'Iwish_bin_masked_full_v102_Gchain_SO_64_v1b' # -> biased binning delta_ell=10 + 2000 iterations + Iwish_v1b + w/o restrict_to_mask + mask + perturbation_eta ; C_approx only lensing
# -> TODO !!!
reduction_noise = 1
factor_Fisher = 1
...
path_toml_file = directory_toml_file + 'Iwish_v1b.toml'
