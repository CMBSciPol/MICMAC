...
file_ver = 'corr_masked_full_v102_Gchain_SO_64_v1e_test' # -> corr inhom + start 10 sigma + seed 0 + r=0 + 2000 iterations + corr_v1cbc + w/o restrict_to_mask + mask ; C_approx only lensing
# -> TODO !!!
reduction_noise = 1
factor_Fisher = 1
...
path_home_test_playground = '/Users/mag/Documents/PHD1Y/Space_Work/Pixel_non_P2D/MICMAC/test_playground/'
perso_repo_path = path_home_test_playground+"/validation_chain_v5/"
# current_path = os.path.dirname(os.path.abspath(''))
# current_path = perso_repo_path
current_path = path_home_test_playground + '/validation_chain_v5/'
...
common_repo = "/Users/mag/Documents/PHD1Y/Masks/"
path_mask = common_repo + "mask_SAT_apodized.fits"
