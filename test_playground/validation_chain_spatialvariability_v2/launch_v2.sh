...
export path_directory_main=$path_local_MICMAC/test_playground/validation_chain_spatialvariability_v2/
export path_Python_script=$path_directory_main/script_v108_v2.py

export file_ver=corr_fullsky_SO_v108_v2a
export add_param_toml=add_corr_fullsky_SO_v2a 
