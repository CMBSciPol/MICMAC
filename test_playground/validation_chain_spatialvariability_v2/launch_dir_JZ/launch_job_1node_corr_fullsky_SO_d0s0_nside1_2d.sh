#!/bin/bash
#SBATCH --job-name=corr_spv_fullsky_SO_2d_1nodes
...
export VER=corr_fullsky_SO_d0s0_nside1_v108_v2fb
export additional_config_file=add_corr_fullsky_SO_d0s0_nside1_v2fb.toml
