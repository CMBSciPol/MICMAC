#!/bin/bash
#SBATCH --job-name=corr_spv_fullsky_SO_2b_1nodes
...
export VER=corr_fullsky_SO_d0s0_nside1_v108_v2cb
export additional_config_file=add_corr_fullsky_SO_d0s0_nside1_v2c.toml
