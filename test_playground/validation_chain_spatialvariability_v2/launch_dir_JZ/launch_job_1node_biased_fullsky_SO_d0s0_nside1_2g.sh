#!/bin/bash
#SBATCH --job-name=biased_spv_fullsky_SO_2g_1nodes
...
export VER=biased_fullsky_SO_d0s0_nside1_v108_v2n
export additional_config_file=add_biased_fullsky_SO_d0s0_nside1_v2n.toml
