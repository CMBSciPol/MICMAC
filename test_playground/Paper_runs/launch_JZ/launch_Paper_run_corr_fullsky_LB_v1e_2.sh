#!/bin/bash
#SBATCH --job-name=corr_Paper_run_LB_v1e_2
...
export VER=corr_cutsky_LB_d0s0_nside0_v1091_r2_v1e7
export additional_config_file=add_corr_cutsky_LB_d0s0_nside0_v1e.toml
