#!/bin/bash
#SBATCH --job-name=corr_Paper_run_LB_v1s
...
export VER=corr_cutsky_LB_d7s0_nside2_v1091_v1a15
export additional_config_file=add_corr_cutsky_LB_d7s0_nside2_v1a.toml
