#!/bin/bash
#SBATCH --job-name=corr_Paper_run_LB_v1g_2
...
export VER=file_ver = 'corr_cutsky_LB_d0s0_nside0_v1091_r0_v1g2'
export additional_config_file=add_corr_cutsky_LB_d0s0_nside0_v1g.toml
