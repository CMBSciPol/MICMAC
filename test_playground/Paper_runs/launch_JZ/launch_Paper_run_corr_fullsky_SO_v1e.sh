#!/bin/bash
#SBATCH --job-name=corr_Paper_run_SO_v1e
...
export VER=corr_cutsky_SO_d7s3_nside2_v1091_v1a12
export additional_config_file=add_corr_cutsky_SO_d7s3_nside2_v1a.toml
