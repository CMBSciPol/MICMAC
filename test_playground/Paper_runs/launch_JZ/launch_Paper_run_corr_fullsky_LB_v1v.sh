#!/bin/bash
#SBATCH --job-name=corr_Paper_run_LB_v1v
...
export VER=corr_cutsky_LB_d7s0_nside16_v1091_v1a14
export additional_config_file=add_corr_cutsky_LB_d7s0_nside16_v1a.toml
