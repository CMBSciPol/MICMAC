#!/bin/bash
#SBATCH --job-name=class_Paper_run_LB_v1d
...
export VER=class_cutsky_LB_d0s0_nside0_v1091_v1d2
export additional_config_file=add_class_cutsky_LB_d0s0_nside0_v1d.toml
