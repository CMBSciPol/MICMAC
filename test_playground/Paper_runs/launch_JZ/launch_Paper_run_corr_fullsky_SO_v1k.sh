#!/bin/bash
#SBATCH --job-name=corr_Paper_run_SO_v1k
...
export VER=corr_cutsky_SO_d7s3_nside64_v1091_v1a
export additional_config_file=add_corr_cutsky_SO_d7s3_nside64_v1a.toml
