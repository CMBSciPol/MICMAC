...
# export VER=corr_cutsky_LB_d0s0_nside0_v1091_r0_v1b14
# export additional_config_file=add_corr_cutsky_LB_d0s0_nside0_v1b.toml

export VER=corr_cutsky_LB_d0s0_nside0_v1091_v2e5
export additional_config_file=add_corr_cutsky_LB_d0s0_nside0_v0e.toml
