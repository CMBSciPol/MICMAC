#!/bin/bash
#SBATCH --job-name=corr_Paper_run_LB_v1f_2
...
export VER=corr_cutsky_LB_d0s0_nside0_v1091_r3_v1f2
export additional_config_file=add_corr_cutsky_LB_d0s0_nside0_v1f.toml
