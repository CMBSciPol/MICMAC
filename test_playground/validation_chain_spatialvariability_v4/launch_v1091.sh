...
export path_directory_main=$path_local_MICMAC/test_playground/validation_chain_spatialvariability_v4/
export path_Python_script=$path_directory_main/script_v109_v3.py


export file_ver=corr_fullsky_SO_d0s0_nside1_v1091_v1a
export add_param_toml=add_corr_fullsky_SO_d0s0_nside1_v1
