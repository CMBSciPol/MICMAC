#!/bin/bash
#SBATCH --job-name=corr_t3_fullsky_SO_1a_1nodes
...
#SBATCH --time=15:00:00            # default: 10 minutes on cpu_p1
...
export VER=corr_fullsky_SO_d1s1_nside8_v1091_v1abbc
export additional_config_file=add_corr_fullsky_SO_d1s1_nside8_v1abbc.toml
