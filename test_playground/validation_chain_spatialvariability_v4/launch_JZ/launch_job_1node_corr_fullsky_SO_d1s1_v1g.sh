#!/bin/bash
#SBATCH --job-name=corr_spv_fullsky_SO_1g_1nodes
...
export VER=corr_fullsky_SO_d1s1_nside32_v1091_v2ab11
export additional_config_file=add_corr_fullsky_SO_d1s1_nside32_v2ab11.toml
