#!/bin/bash
#SBATCH --job-name=corr_spv_fullsky_SO_1b_1nodes
...
export VER=corr_fullsky_SO_d1s1_nside1_v1091_v2abbb
export additional_config_file=add_corr_fullsky_SO_d1s1_nside1_v2abbb.toml
