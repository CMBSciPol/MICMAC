#!/bin/bash
#SBATCH --job-name=corr_spv_fullsky_SO_1f_1nodes
...
export VER=corr_fullsky_SO_d1s1_nside16_v1091_v2ab15
export additional_config_file=add_corr_fullsky_SO_d1s1_nside16_v2ab15.toml
