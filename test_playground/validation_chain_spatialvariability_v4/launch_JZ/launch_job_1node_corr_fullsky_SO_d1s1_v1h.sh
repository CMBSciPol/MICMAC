#!/bin/bash
#SBATCH --job-name=corr_spv_fullsky_SO_1h_1nodes
...
export VER=corr_fullsky_SO_d1s1_nside64_v1091_v2a
export additional_config_file=add_corr_fullsky_SO_d1s1_nside64_v2a.toml
