#!/bin/bash
#SBATCH --job-name=corr_spv_fullsky_SO_1c_1nodes
...
export VER=corr_fullsky_SO_d1s1_nside2_v1091_v1abbb
export additional_config_file=add_corr_fullsky_SO_d1s1_nside2_v1abbb.toml
