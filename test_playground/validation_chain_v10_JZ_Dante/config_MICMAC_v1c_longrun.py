...
if MICMAC_obj.sample_eta_B_f:
    ...
    step_size_B_f[:,0] = step_size_B_f_r_diag[:MICMAC_obj.n_frequencies-len_pos_special_freqs]
    step_size_B_f[:,1] = step_size_B_f_r_diag[MICMAC_obj.n_frequencies-len_pos_special_freqs:2*(MICMAC_obj.n_frequencies-len_pos_special_freqs)]
