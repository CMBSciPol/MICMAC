#!/bin/bash
#SBATCH --job-name=corr_fullsky_1a_5nodes_gpu
...
source /work/morshed/MICMAC/.bash_env
...
# export VER=corr_fullsky_v104_v1a_gpu
export VER=corr_fullsky_v104_v1a2_gpu
export additional_config_file=add_gpu_corr_fullsky_v1a.toml
