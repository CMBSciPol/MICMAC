#!/bin/bash
#SBATCH --job-name=corr_fullsky_LB_1a_5walkers
...
export VER=corr_fullsky_LB_v107_v1a
export additional_config_file=add_corr_fullsky_LB_v1a.toml

export SRC_PATH=/gpfswork/rech/nih/ube74zo/MICMAC/MICMAC/test_playground/validation_chain_v10_JZ_Dante

srun python $SRC_PATH/config_MICMAC_v1d_longrun.py $additional_config_file  1> $SRC_PATH/logs/log_$VER.log 2> $SRC_PATH/errs/err_$VER.log
