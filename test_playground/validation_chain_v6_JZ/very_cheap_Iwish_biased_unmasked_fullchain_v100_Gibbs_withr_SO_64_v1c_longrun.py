...
file_ver = 'Iwish_biased_unmasked_full_v100_Gchain_SO_64_v3ab' # -> 4000 iterations + with B_f/eta + unmask + invWishart + Iwish_biased_full_chain_v1c ; C_approx only lensing
# -> TODO !!!
reduction_noise = 1
factor_Fisher = 1
