...
#SBATCH --cpus-per-task=32          # nbr of OpenMP threads
#SBATCH --hint=nomultithread       # 1 thread / physical core (no hyperthreading)
#SBATCH --time=45:00:00            # default: 10 minutes on cpu_p1
...
srun python /linkhome/rech/genkqu01/ube74zo/MICMAC/MICMAC/test_playground/validation_chain_v6_JZ/very_cheap_biased_unmasked_fullchain_v100_Gibbs_withr_SO_64_v1b_longrun.py  1> logs/log_biased_unmasked_full_v101_Gchain_SO_64_v2b.log 2> errs/err_biased_unmasked_full_v101_Gchain_SO_64_v2b.log
