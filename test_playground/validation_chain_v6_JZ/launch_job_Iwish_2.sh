...
srun python /linkhome/rech/genkqu01/ube74zo/MICMAC/MICMAC/test_playground/validation_chain_v6_JZ/very_cheap_Iwish_biased_masked_fullchain_v100_Gibbs_withr_SO_64_v1a_longrun.py  1> logs/log_Iwish_biased_unmasked_full_v100_Gchain_SO_64_v3a.log 2> errs/err_Iwish_biased_unmasked_full_v100_Gchain_SO_64_v3a.log
