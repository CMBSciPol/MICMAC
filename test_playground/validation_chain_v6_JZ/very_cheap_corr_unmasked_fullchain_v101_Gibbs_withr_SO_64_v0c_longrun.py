...
file_ver = 'corr_unmasked_full_v102_Gchain_SO_64_v0a' # -> WF&Fluct v2c ; 3500 iterations + corr_full_chain_v2d  + w/o restrict_to_mask + 50 limit_iter_eta + unmasked + func_norm w/o mask ; C_approx only lensing
file_ver = 'corr_unmasked_full_v102_Gchain_SO_64_v0b' # -> perturbation_eta ; 3500 iterations + corr_full_chain_v3ab  + w/o restrict_to_mask + 200 limit_iter_eta + unmasked + func_norm w/o mask ; C_approx only lensing
# -> TODO !!!
reduction_noise = 1
factor_Fisher = 1
