...
file_ver = 'Iwish_biased_unmasked_full_v100_Gchain_SO_64_v2d' # -> 2000 iterations + no B_f/eta + masked + invWishart + Iwish_biased_full_chain_v1b ; C_approx only lensing
# -> TODO !!!
reduction_noise = 1
factor_Fisher = 1
