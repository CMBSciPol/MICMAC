...
file_ver = 'corr_unmasked_full_v101_Gchain_SO_64_v0c' # -> WF&Fluct v2c ; 3500 iterations + corr_full_chain_v2d  + restrict_to_mask + 50 limit_iter_eta + unmasked + func_norm w/o mask ; C_approx only lensing
# -> TODO !!!
reduction_noise = 1
factor_Fisher = 1
...
path_toml_file = directory_toml_file + 'corr_full_chain_v2d.toml'
