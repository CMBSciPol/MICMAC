#!/bin/bash
#SBATCH --job-name=corr_2
#SBATCH --account=nih@cpu          # use CPU allocation
#SBATCH --qos=qos_cpu-t4          # dev qos (10 jobs, 2h max.)
...
#SBATCH --time=50:00:00            # default: 10 minutes on cpu_p1
...
export VER=corr_masked_full_v100_Gchain_SO_64_v3db

export SRC_PATH=/linkhome/rech/genkqu01/ube74zo/MICMAC/MICMAC/test_playground/validation_chain_v6_JZ
srun python $SRC_PATH/very_cheap_corr_masked_fullchain_v101_Gibbs_withr_SO_64_v1d_longrun.py  1> $SRC_PATH/logs/log_$VER.log 2> $SRC_PATH/errs/err_$VER.log
