...
srun python /linkhome/rech/genkqu01/ube74zo/MICMAC/MICMAC/test_playground/validation_chain_v6_JZ/very_cheap_corr_masked_fullchain_v101_Gibbs_withr_SO_64_v1c_longrun.py  1> logs/log_corr_masked_full_v100_Gchain_SO_64_v3a.log 2> errs/err_corr_masked_full_v100_Gchain_SO_64_v3a.log
