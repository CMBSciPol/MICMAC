...
export VER=corr_unmasked_Iwish_full_v102_Gchain_SO_64_v0c

export SRC_PATH=/linkhome/rech/genkqu01/ube74zo/MICMAC/MICMAC/test_playground/validation_chain_v6_JZ
# srun python $SRC_PATH/very_cheap_corr_masked_fullchain_v101_Gibbs_withr_SO_64_v1c_longrun.py  1> $SRC_PATH/logs/log_$VER.log 2> $SRC_PATH/errs/err_$VER.log
srun python $SRC_PATH/very_cheap_corr_Iwish_unmasked_fullchain_v101_Gibbs_withr_SO_64_v0c_longrun.py  1> $SRC_PATH/logs/log_$VER.log 2> $SRC_PATH/errs/err_$VER.log
