...
srun python $SRC_PATH/very_cheap_corr_masked_fullchain_v101_Gibbs_withr_SO_64_v1d_longrun.py  1> $SRC_PATH/logs/log_corr_masked_full_v100_Gchain_SO_64_v3b.log 2> $SRC_PATH/errs/err_corr_masked_full_v100_Gchain_SO_64_v3b.log
