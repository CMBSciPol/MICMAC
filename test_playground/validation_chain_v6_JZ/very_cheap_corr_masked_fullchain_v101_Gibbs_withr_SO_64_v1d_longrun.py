...
file_ver = 'corr_masked_full_v100_Gchain_SO_64_v3bb' # -> WF&Fluct v2c ; 2250 iterations + corr_full_chain_v2b  + restrict_to_mask + 200 limit_iter_eta + mask + func_norm w/o mask ; C_approx only lensing
file_ver = 'corr_masked_full_v100_Gchain_SO_64_v3db' # -> WF&Fluct v2c ; 1500 iterations + corr_full_chain_v2ac  + restrict_to_mask + 100 limit_iter_eta + mask + func_norm w/o mask ; C_approx only lensing
# -> TODO !!!
reduction_noise = 1
factor_Fisher = 1
...
path_toml_file = directory_toml_file + 'corr_full_chain_v2ac.toml'
