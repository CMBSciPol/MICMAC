...
file_ver = 'full_v94_Gchain_SO_64_v1a' # -> 5000 iterations + 10% error + step-size_r 1e^-3 + test_full_chain_94_v1a + initial_guess_r = 1e-8 ; C_approx only lensing
file_ver = 'full_v94_Gchain_SO_64_v1b' # -> 2000 iterations + 10% error + step-size_r 1e^-3 + test_full_chain_94_v1b + initial_guess_r = 1e-8 ; C_approx only lensing
reduction_noise = 1
...
path_toml_file = directory_toml_file + 'full_chain_v1b.toml'
