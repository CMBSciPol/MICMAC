...
file_ver = 'biased_full_v94_Gchain_SO_64_v2ia' # -> 15000 iterations + only dust + 10% error + biased_full_chain_v2ec ; C_approx only lensing
# -> TODO !!!
reduction_noise = 1
factor_Fisher = 1
...
path_toml_file = directory_toml_file + 'biased_full_chain_v2ec.toml'
