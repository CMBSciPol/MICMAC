...
file_ver = 'class_v94_Gchain_SO_64_v3a' # -> 2000 iterations + 10% error + step-size_r 1e^-3 + class_chain_v3a + initial_guess_r = 1e-8 ; C_approx only lensing
file_ver = 'class_v94_Gchain_SO_64_v3b' # -> 2000 iterations + 10% error + step-size_r 1e^-3 + class_chain_v3b + initial_guess_r = 1e-8 ; C_approx only lensing
...
path_toml_file = directory_toml_file + 'class_chain_v3a.toml'
path_toml_file = directory_toml_file + 'class_chain_v3b.toml'
...
alternative_synch_step_size = (MICMAC_obj.frequency_array[0]/MICMAC_obj.frequency_array)**3
alternative_dust_step_size = 1/(MICMAC_obj.frequency_array[-1]/MICMAC_obj.frequency_array)**3
