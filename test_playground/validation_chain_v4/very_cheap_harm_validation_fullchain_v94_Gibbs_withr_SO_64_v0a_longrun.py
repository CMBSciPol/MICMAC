...
file_ver = 'full_v94_Gchain_SO_64_v0a' # -> 4000 iterations + 10% error + step-size_r 1e^-3 + harm_full_chain_v0a + initial_guess_r = 1e-8 ; C_approx only lensing
# -> TODO !!!
reduction_noise = 1
...
path_toml_file = directory_toml_file + 'harm_full_chain_v0a.toml'
