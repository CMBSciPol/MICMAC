#!/bin/bash
#SBATCH --job-name=corr_Paper_run_SO_v1gb
...
export VER=corr_cutsky_SO_d7s0_nside4_v1091b_v1b8
export additional_config_file=add_corr_cutsky_SO_d7s0_nside4_v1b.toml
