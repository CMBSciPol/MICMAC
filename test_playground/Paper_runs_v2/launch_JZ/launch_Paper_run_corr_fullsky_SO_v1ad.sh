#!/bin/bash
#SBATCH --job-name=corr_Paper_run_SO_v1ad
...
export VER=corr_cutsky_SO_d1s1_nside0_v1091b_v2c6
export additional_config_file=add_corr_cutsky_SO_d1s1_nside0_v2c.toml
