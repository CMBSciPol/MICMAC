#!/bin/bash
#SBATCH --job-name=corr_Paper_run_SO_v1db
...
export VER=corr_cutsky_SO_d7s0_nside0_v1091b_v1c4
export additional_config_file=add_corr_cutsky_SO_d7s0_nside0_v1c.toml
