#!/bin/bash
#SBATCH --job-name=corr_Paper_run_SO_v2ae
...
# export VER=corr_fullsky_LB_d0s0_nside0_v1091c_r2_v1a
# export additional_config_file=add_corr_fullsky_LB_d0s0_nside0_v2a.toml

# export VER=corr_fullsky_SO_d0s0_r2_v1ae5
# export additional_config_file=add_corr_fullky_SO_d0s0_v1ae.toml

export VER=corr_fullsky_SO_d0s0_r2_v1aeb
export additional_config_file=add_corr_fullky_SO_d0s0_v1aeb.toml
