#!/bin/bash
#SBATCH --job-name=corr_Paper_run_SO_v2a
...
# export VER=corr_fullsky_LB_d0s0_r0_v1b10
# export additional_config_file=add_corr_fullky_LB_d0s0_v1b.toml

# export VER=corr_fullsky_LB_d0s0_r0_v1be6
# export additional_config_file=add_corr_fullky_LB_d0s0_v1be.toml
...
export VER=corr_cutsky_d7s1customNonparam_SO_nside0_v1091c_r0_v1a15
export additional_config_file=add_corr_cutsky_SO_d7s1customNonparam_nside0_v1a.toml

export VER=corr_cutsky_SO_d0s0noiseless_nside0_v1091c_r0_v1a3
export additional_config_file=add_corr_cutsky_SO_d0s0noiseless_nside0_v1a.toml
