#!/bin/bash
#SBATCH --job-name=corr_Paper_run_SO_v1g
...
# export VER=corr_cutsky_SO_d7s0_nside0_v1091c_r0_v1a4
# export additional_config_file=add_corr_cutsky_SO_d7s0_nside0_v1a.toml

export VER=corr_cutsky_SO_d7s0_nside8_v1091c_r0_v1ab12
export additional_config_file=add_corr_cutsky_SO_d7s0_nside8_v1a.toml
