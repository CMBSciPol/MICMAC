#!/bin/bash
#SBATCH --job-name=corr_Paper_run_SO_v1a
...
export VER=corr_cutsky_SO_d1s1_nside2_v1091c_r0_v1ab11
export additional_config_file=add_corr_cutsky_SO_d1s1_nside2_v1a.toml
