#!/bin/bash
#SBATCH --job-name=corr_Paper_run_SO_v2g
...
# export VER=corr_fullsky_LB_d0s0_r0_v1bc2
# export additional_config_file=add_corr_fullky_LB_d0s0_v1bc.toml

# export VER=corr_fullsky_LB_d0s0_r0_v1bf6
# export additional_config_file=add_corr_fullky_LB_d0s0_v1bf.toml

# export VER=corr_fullsky_LB_d0s0_r0_v1bfb7
# export additional_config_file=add_corr_fullky_LB_d0s0_v1bfb.toml

export VER=corr_fullsky_LB_d0s0_r0_v1bfc11
export additional_config_file=add_corr_fullky_LB_d0s0_v1bfc.toml
