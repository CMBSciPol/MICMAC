#!/bin/bash
#SBATCH --job-name=corr_Paper_run_SO_v2e
...
export VER=corr_cutsky_SO_d0s0_nside0_v1091c_r0_inhom_v1ab14
export additional_config_file=add_corr_cutsky_SO_d0s0_nside0_inhom_v1a.toml
