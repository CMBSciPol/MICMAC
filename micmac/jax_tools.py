...
def get_sqrt_reduced_matrix_from_matrix_jax(red_matrix):
    ...
    reduced_sqrtm = jnp.einsum("ljk,km,lm,lmn->ljn",
                               eigvect,
                               jnp.eye(nstokes),
...
def frequency_alms_x_obj_red_covariance_cell_JAX(
    ...
    first_dim_red_matrix = freq_red_matrix.shape[0] # Can be any dimension, in the use of the function either n_frequencies or n_components
